...
To refresh: `python3 scripts/refresh-hig.py`. It fetches a fresh Apple documentation snapshot,
regenerates component/pattern condensations, and updates `references/technologies.md` plus
`references/coverage.md`. Pass `--use-cache` only when an older snapshot is intentional.
Hand-written files (`foundations.md`, `foundations-extended.md`,
